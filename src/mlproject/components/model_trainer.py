...
class ModelTrainner:
    def __init__(self):
        self.model_tariner_config =ModelTrainnerconfig()
    ...
    def initate_model_trainer(self,train_array,test_array):
        try:
            logging.info("initing model and split trainning input data")
            ...
            mlflow.set_registry_uri("https://dagshub.com/shubham3032002/ML-project.mlflow")
            ...
            save_object(
                file_path=ModelTrainnerconfig.trained_model_file_path,
                obj=best_model
            )
